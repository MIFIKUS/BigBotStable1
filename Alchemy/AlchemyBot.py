...
TIME_FOR_AUTOSELL = ('21:00', '21:01', '21:02', '21:03', '21:04', '21:05', '21:06', '21:07', '21:08', '21:09',
...
TIME_FOR_SBOR = ('10:00', '10:01', '10:02', '10:03', '10:04', '10:05', '10:06', '10:07', '10:08', '10:09',
...
def run(hwnd):
    ...
    def _open_market():
        ahk.mouse_actions('move', x=1430, y=455)
        ahk.mouse_actions('click')
...
def roll_80(hwnd):
    ...
    def _open_alchemy():
        ahk.mouse_actions('move', x=1700, y=460)
        ahk.mouse_actions('click')
